...
<div> <p className="footer-text">Elegant flowers & gifts for your special moments</p>
         <h6 className="copy"> © {new Date().getFullYear()} BY.Mostafa Omar | Phone: 01111695090.</h6>
   </div>
