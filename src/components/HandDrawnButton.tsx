...
const HandDrawnButton = ({ title }: HandDrawnButtonProps) => {
  return (
    <motion.button 
      className="button relative text-center transition-all duration-300 cursor-pointer bg-transparent inline-flex items-center font-mono font-bold text-lg px-8 py-4 rounded-3xl shadow-[0_4px_4px_rgba(51,51,51,0.4)] hover:shadow-xl hover:shadow-black/30"
