  ...
  return (
    <>
      ...
      <button
        ...
        className="indexx iconn fixed top-[40%] right-[1px] bg-gradient-to-r from-pink-500 to-purple-500 text-white p-5 sm:p-3 w-16 h-16 sm:w-12 sm:h-12 rounded-full shadow-lg hover:shadow-xl transition-all z-[60] flex items-center justify-center"
      >
