...
export default function PressButton({ product }: { product: any }) {
...
>
  ...
  <div className="button-text flex items-center gap-2"> <span className="">Buy</span> <span> Now </span> </div>
